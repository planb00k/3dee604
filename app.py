...
if uploaded_file:
    ...
    st.image(depth_color, caption="Depth Map", use_column_width=True)
    ...
    # --- Histogram & Object Masking (from Notebook) ---
    ...
    st.image(temp, caption="Annotated Image", use_column_width=True)
